<?php
$hcz_terms = apply_filters('get_portfolio_tags',array('post_tag'),array(HCZ_PF_POST_TYPE));
$hcz_project_pics = apply_filters('get_portfolio_photos',HCZ_PF_POST_TYPE);
$hcz_project_date = apply_filters('get_portfolio_date',HCZ_PF_POST_TYPE);
$hcz_project_link = apply_filters('get_portfolio_link',HCZ_PF_POST_TYPE);
?>
<style type="text/css">
	ul.project-stats {
...
<?php endif; ?>
    <div class="row">
    	<div class="col-md-8">
            ...
            <ul id="portfolio" class="bxslider portfolio-slider">
